...
proc llvmCreateOptimizer*(): LlvmLtoT {.importc: "llvm_create_optimizer",
                                     dynlib: LLVMLib.}
proc llvmDestroyOptimizer*(lto: LlvmLtoT) {.importc: "llvm_destroy_optimizer",
    dynlib: LLVMLib.}
proc llvmReadObjectFile*(lto: LlvmLtoT; inputFilename: cstring): LlvmLtoStatusT {.
    importc: "llvm_read_object_file", dynlib: LLVMLib.}
proc llvmOptimizeModules*(lto: LlvmLtoT; outputFilename: cstring): LlvmLtoStatusT {.
    importc: "llvm_optimize_modules", dynlib: LLVMLib.}
## *
##  @}
## 
