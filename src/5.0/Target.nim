...
# proc initializeNativeTarget*(): Bool {.importc: "LLVMInitializeNativeTarget", dynlib: LLVMLib.}
## * LLVMInitializeNativeTargetAsmParser - The main program should call this
##     function to initialize the parser for the native target corresponding to the
##     host.

# proc initializeNativeAsmParser*(): Bool {.importc: "LLVMInitializeNativeAsmParser", dynlib: LLVMLib.}
## * LLVMInitializeNativeTargetAsmPrinter - The main program should call this
##     function to initialize the printer for the native target corresponding to
##     the host.

# proc initializeNativeAsmPrinter*(): Bool {.importc: "LLVMInitializeNativeAsmPrinter", dynlib: LLVMLib.}
## * LLVMInitializeNativeTargetDisassembler - The main program should call this
##     function to initialize the disassembler for the native target corresponding
##     to the host.

# proc initializeNativeDisassembler*(): Bool {.importc: "LLVMInitializeNativeDisassembler", dynlib: LLVMLib.}
## ===-- Target Data -------------------------------------------------------===
## *
