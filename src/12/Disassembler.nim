...
type
  OpInfoCallback* = proc (disInfo: pointer; pc: uint64; offset: uint64; size: uint64;
...
type
  SymbolLookupCallback* = proc (disInfo: pointer; referenceValue: uint64;
                             referenceType: ptr uint64; referencePC: uint64;
...
proc CreateDisasm*(tripleName: cstring; disInfo: pointer; tagType: cint;
                  getOpInfo: OpInfoCallback; symbolLookUp: SymbolLookupCallback): DisasmContextRef  {.llvmc.}
## *
...
proc CreateDisasmCPUFeatures*(triple: cstring; cpu: cstring; features: cstring;
                             ...
                             symbolLookUp: SymbolLookupCallback): DisasmContextRef  {.llvmc.}
## *
##  Set the disassembler's options.  Returns 1 if it can set the Options and 0
##  otherwise.
##

proc SetDisasmOptions*(dc: DisasmContextRef; options: uint64): cint  {.llvmc.}
...
proc DisasmDispose*(dc: DisasmContextRef) {.llvmc.}
## *
...
proc DisasmInstruction*(dc: DisasmContextRef; bytes: ptr uint8T; bytesSize: uint64;
                       pc: uint64; outString: cstring; outStringSize: csize_t): csize_t  {.llvmc.}
## *
##  @}
##
